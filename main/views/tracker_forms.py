    ...
    if request.method == "POST":
        ...
        if deuxiememainbe_form.is_valid():
            ...
            if deuxiememainbe_form.data['distance_meters'] is "0":
                 ds = None
            if (user_contact.super_premium_user and number_of_tracker < 10) or\
                    (user_contact.premium_user and number_of_tracker < 5) or\
                    (user_contact.normal_user and number_of_tracker < 2):
